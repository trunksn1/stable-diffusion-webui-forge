...
class Script(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        return [info, overlap, upscaler_index, scale_factor, wantPrompt, wantNegative, wantSeed, wantSteps,
                wantCFGScale, wantSize, wantdenoise]

    def run(self, p, _, overlap, upscaler_index, scale_factor, wantPrompt, wantNegative, wantSeed, wantSteps,
            wantCFGScale, wantSize, wantdenoise):
